jQuery(function($) {
    ...
    // Browse Files Tree
    //Créditos familiares info
    var fileData = [
        {
            id: 1,
            name: 'Cónyugue',
            icons: {
                'default': ['<i class="fas fa-person"></i>', 'text-blue-m1']
            },
            children: [
                {
                    id: 2,
                    name: 'Cuando ambos cónyugues sean contribuyentes sólo uno de ellos podrá aplicarse los créditos',
                },
                {
                    id: 3,
                    name: 'El crédito aplica para el cónyugue siempre y cuando no exista separación legal.',
                }
            ]
        },
        {
            ...
            name: 'Hijos',
            icons: {
                'default': ['<i class="fas fa-children"></i>', 'text-info']
            },
            children: [
                {
                    id: 5,
                    name: 'Cuando sean menores de edad.',
                },
                {
                    id: 6,
                    name: 'Que estén imposibilitados para proveerse su propio sustento debido a incapacidad física o mental.',
                },
                {
                    id: 7,
                name: 'Cuando estén realizando estudios superiores, siempre y cuando no sean mayores de 25 años.',
                },
                {
                    id: 8,
                    name: 'En caso de que ambos cónyugues sean contribuyentes, los créditos por los hijos sólo pueden ser deducido por uno de ellos.',
                }
            ]
        }
    ]
    ...
    //Planilla chequeo de planilla
    var fileDataPlanilla = [
        {
            id: 1,
            name: 'Chequeo de incapacidades.',
        },
        {
            id: 2,
            name: 'Chequeo de préstamos.',
        },
        {
            id: 3,
            name: 'Chequeo de Vacaciones.',
        },
        {
            id: 4,
            name: 'Chequeo de Suspensiones.',
        },
        {
            id: 5,
            name: 'Chequeo de Embargos.',
        },
        {
            id: 6,
            name: 'Chequeo de Pensiones Alimenticias.',
        }
    ]


    var fileTree = $('#id-jqtree-files-planilla')
    fileTree
        .tree({
            data: fileDataPlanilla,
            autoOpen: 1,
            // dragAndDrop: true,
            useContextMenu: true,
