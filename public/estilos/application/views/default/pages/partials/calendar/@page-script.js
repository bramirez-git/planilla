/*jQuery(function($) {
  ...
  var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
    ...
    selectLongPressDelay: 200,
      ...
      bootbox.prompt("Titulo del nuevo evento:", function(title) {
            ...
            <form class="m-0">\
              <div class="input-group">\
                  ...
                  <div class="input-group-append">\
                    <button type="submit" class="btn btn-sm btn-success btn-bold"><i class="fa fa-check mr-2px"></i> Guardar</button>\
