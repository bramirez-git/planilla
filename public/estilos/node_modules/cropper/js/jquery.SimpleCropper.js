...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        function preview() {
            ...
            var imagenCodigo = document.createElement('input');
            imagenCodigo.value = dataUrl.replace("data:image/png;base64,","");
            imagenCodigo.id="frm_fotos";
            imagenCodigo.name="frm_fotos";
            ...
            file_display_area.append(imagenCodigo);
