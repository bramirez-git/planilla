...
@section('page-content')
    ...
    <form class="mt-lg-3" autocomplete="off" method="POST" action="{{route('miscelaneosNotificacionesEmail.update',['1'])}}">
        @csrf
        @method('PUT')
        <div class="row pb-3">
            <div class="col-md-8">
                <div class="form-group row">
                    <div class="col-md-6 col-sm-12">
                        <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Primer Nombre') }}</label>
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ¿Desea modificar la notificación?
                            <br />
                        </div>
            ...
            <div class="col-md-4" id='external-events'>
                <div class="bgc-white shadow-sm p-35 radius-1">
                    ...
                    <div class="row">
                        <div class="col-12 pt-2">{{ _('Nombre Colaborador: ') }}</div>
                       <div class="col-12"> <button type="button" class='mt-2 variables_clic badge bgc-blue-d1 text-white border-0 py-2 ml-2 text-90 mb-1 radius-2px' data-class="bgc-blue-d1 text-white text-95">
                            ##Nombre_Colaborador##
                        </button></div>
                       </div>
                    <div class="row">
                        <div class="col-12 pt-2">{{ _('Correo Colaborador: ') }}</div>
                        <div class="col-12"><button type="button" class='mt-2 variables_clic badge bgc-green-d2 text-white border-0 py-2 ml-2 text-90 mb-1 radius-2px' data-class="bgc-green-d2 text-white text-95">
                            ###Correo_colaborador#
                        </button></div>
                    ...
                    <div class="row">
                    <div class="col-12 pt-2">{{ _('Nombre empresa: ') }}</div>
                    <div class="col-12"> <button type="button" class='mt-2 variables_clic badge bgc-red-d1 text-white border-0 py-2 ml-2 text-90 mb-1 radius-2px' data-class="bgc-red-d1 text-white text-95">
                            ##Nombre_Empresa##
                        </button></div>
                    </div>
                    <div class="row">
                    <div class="col-12 pt-2">{{ _('Extensión: ') }}</div>
                    <div class="col-12"> <button type="button" class='mt-2 variables_clic badge bgc-purple-d1 text-white border-0 py-2 ml-2 text-90 mb-1 radius-2px' data-class="bgc-purple-d1 text-white text-95">
                            ##Extension##
                        </button></div>
                    </div>
                     <div class="row">
                    <div class="col-12 pt-2">{{ _('Mi firma: ') }}</div>
                    <div class="col-12"> <button type="button" class='mt-2 variables_clic badge bgc-orange-d1 text-white border-0 py-2 ml-2 text-90 mb-1 radius-2px' data-class="bgc-orange-d1 text-white text-95">
                            ##Mi_firma##
                        </button></div>
                    </div>
