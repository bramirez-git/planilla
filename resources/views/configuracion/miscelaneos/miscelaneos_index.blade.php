                    ...
                    <div class="p-3 text-justify">
                        <div class="d-flex flex-column flex-md-row justify-content-end">
                            <!--<div class="text-nowrap align-self-start mb-sm-0 pb-4">
                                <a href="{{ route('miscelaneosNotificacionesEmail.create') }}" class="btn btn-outline-blue btn-text-dark btn-h-blue btn-a-blue btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px ">
                            ...
                            <table id="simple-table" class="resp mb-0 table  table-borderless table-bordered-x  text-dark-m2 radius-1 overflow-hidden border-t-3 brc-blue-m2">
                                ...
                                <tr class="bgc-h-blue-l4 d-style text-center">
                                  ...
                                  <td class="text-95 text-center">
                                    ...
                                    <td class='d-none d-sm-table-cell text-95 text-center'>
                                        07-02-2022
                                    </td>

                                     <td class="text-center">

                                        <form method="POST" action="{{ route('miscelaneosNotificacionesEmail.destroy',['1']) }}">
                                            @csrf
                                            @method('DELETE')
                                            <!-- action buttons -->
                                            <div class='d-none d-lg-flex float-right'>
                                                <a href="{{ route('miscelaneosNotificacionesEmail.edit',['1']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('miscelaneosNotificacionesEmail.edit',['1']) }}" class="dropdown-item">
                                ...
                                <tr class="bgc-h-blue-l4 d-style text-center">
                                    ...
                                    <td class="d-none d-sm-table-cell text-600 text-orange-d2">
                                        2
                                    </td>
                                    ...
                                    <td class='d-none d-sm-table-cell text-95'>
                                       26-11-2021
                                    </td>

                                     <td class="text-center">

                                        <form method="POST" action="{{ route('miscelaneosNotificacionesEmail.destroy',['2']) }}">
                                            @csrf
                                            @method('DELETE')
                                            <!-- action buttons -->
                                            <div class='d-none d-lg-flex float-right'>
                                                <a href="{{ route('miscelaneosNotificacionesEmail.edit',['2']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('miscelaneosNotificacionesEmail.edit',['2']) }}" class="dropdown-item">
                                                            <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                                            {{ __('Editar') }}
                                                        </a>
                                ...
                                <tr class="bgc-h-blue-l4 d-style text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form method="POST" action="{{ route('miscelaneosNotificacionesEmail.destroy',['3']) }}">
                                            @csrf
                                            @method('DELETE')
                                            <!-- action buttons -->
                                            <div class='d-none d-lg-flex float-right'>
                                                <a href="{{ route('miscelaneosNotificacionesEmail.edit',['3']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('miscelaneosNotificacionesEmail.edit',['3']) }}" class="dropdown-item">
                                                            <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                                            {{ __('Editar') }}
                                                        </a>
                                ...
                                <tr class="bgc-h-blue-l4 d-style text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form method="POST" action="{{ route('miscelaneosNotificacionesEmail.destroy',['4']) }}">
                                            @csrf
                                            @method('DELETE')
                                            <!-- action buttons -->
                                            <div class='d-none d-lg-flex float-right'>
                                                <a href="{{ route('miscelaneosNotificacionesEmail.edit',['4']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('miscelaneosNotificacionesEmail.edit',['4']) }}" class="dropdown-item">
                                                            <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                                            {{ __('Editar') }}
                                                        </a>
                                ...
                                <tr class="bgc-h-blue-l4 d-style text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form method="POST" action="{{ route('miscelaneosNotificacionesEmail.destroy',['5']) }}">
                                            @csrf
                                            @method('DELETE')
                                            <!-- action buttons -->
                                            <div class='d-none d-lg-flex float-right'>
                                                <a href="{{ route('miscelaneosNotificacionesEmail.edit',['5']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                            ...
                                            <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                                ...
                                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                                    <div class="dropdown-inner">
                                                        ...
                                                        <a href="{{ route('miscelaneosNotificacionesEmail.edit',['5']) }}" class="dropdown-item">
                                                            <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                                            {{ __('Editar') }}
                                                        </a>
