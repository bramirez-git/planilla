        ...
        <div id="loginBgCarousel" class="carousel slide minw-100 h-100">
            ...
            <div class="carousel-inner minw-100 h-100">
                ...
                <div class="carousel-item minw-100 h-100">
                    ...
                    <div style="background-image: url({{ asset('estilos/assets/image/login-bg-2.svg') }});" class="d-flex flex-column align-items-center justify-content-start">
                ...
                <div class="carousel-item minw-100 h-100">
                    <div style="background-image: url({{ asset('estilos/assets/image/login-bg-3.jpg') }});" class="d-flex flex-column align-items-center justify-content-start">
                ...
                <div class="carousel-item minw-100 h-100">
                    <div style="background-image: url({{ asset('estilos/assets/image/login-bg-4.jpg') }});" class="d-flex flex-column align-items-center justify-content-start">
                        <a class="mt-5 mb-2" href="html/dashboard.html">
                            <i class="fa fa-leaf text-success-m2 fa-3x"></i>
                        </a>
