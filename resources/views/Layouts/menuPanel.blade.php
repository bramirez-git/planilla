...
<div class="body-container">
    <nav class="navbar navbar-expand-lg navbar-fixed navbar-skyblue">
        <div class="navbar-inner">
            ...
            <span class="pos-rel">
                  <img class="border-2 brc-white-tp1 radius-round" width="36" src="{{ asset('estilos/assets/image/avatar/avatar6.jpg') }}">
                ...
                <div class="navbar-nav">
                      ...
                      <span class="text-dark-tp4 text-600 text-90 text-uppercase">
                        ...
                        <li class="nav-item dropdown order-first order-lg-last">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <img id="id-navbar-user-image" class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2 w-6" src="{{ asset('estilos/assets/image/avatar/avatar6.jpg') }}">
                    ...
                    <span class="nav-user-name">{{ session()->get('name') }}</span>
                            ...
                            <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3 py-1">
                                ...
                                <a href="#" class="mt-1 dropdown-item btn btn-outline-grey bgc-h-primary-l3 btn-h-light-primary btn-a-light-primary" href="html/page-profile.html">
                                ...
                                <a class="dropdown-item btn btn-outline-grey bgc-h-secondary-l3 btn-h-light-secondary btn-a-light-secondary" href="{{ route('panelLogout') }}"
                                   onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                    <i class="fa fa-power-off text-warning-d1 text-105 mr-1"></i>
                                    {{ __('Cerrar Sesion') }}
                                </a>

                                <form id="logout-form" action="{{ route('panelLogout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </div>
                        </li><!-- /.nav-item:last -->
    ...
    <div class="main-container bgc-white">
        ...
        <div id="sidebar" class="sidebar sidebar-fixed expandable sidebar-dark">
            <div class="sidebar-inner">
                ...
                <div class="ace-scroll flex-grow-1" data-ace-scroll="{}">
                    ...
                    <ul class="nav has-active-border">
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'clientes')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/clientes') }}" class="nav-link">
                                <i class="nav-icon fa fa-people-group"></i>
                                <span class="nav-text fadeable"> <span>Clientes</span></span>
                            </a>
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'reportes')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/reportes') }}" class="nav-link">
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'noticias')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/noticiasPanel') }}" class="nav-link">
                                <i class="nav-icon fa fa-circle-exclamation"></i>
                                <span class="nav-text fadeable"> <span>Noticias</span></span>
                            </a>
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'configuracion')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/configuracion') }}" class="nav-link">
                                <i class="nav-icon fa fa-screwdriver-wrench"></i>
                                <span class="nav-text fadeable"> <span>Configuración</span></span>
                            </a>

                            <b class="sub-arrow"></b>
                        </li>

                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'panelMiscelaneos') ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/panelMiscelaneos') }}" class="nav-link">
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'usuarios')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/usuarios') }}" class="nav-link">
                                <i class="nav-icon fa fa-user-group"></i>
                                <span class="nav-text fadeable"> <span>Usuarios</span></span>
                            </a>
                        ...
                        <li class="nav-item {{ starts_with(Route::currentRouteName(), 'marketplace')  ? 'active' : '' }}">
                            <a href="{{ url('panelAdministracion/marketplace') }}" class="nav-link">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-item fadeable-bottom">
                        <div class="fadeinable">
                            ...
                            <div class="pos-rel">
                                <img alt="Alexa's Photo" src="{{ asset('estilos/assets/image/avatar/avatar3.jpg') }}" width="42" class="px-1px radius-round mx-2 border-2 brc-default-m2" />
                        ...
                        <div class="fadeable hideable w-100 bg-transparent shadow-none border-0">
                            ...
                            <div id="sidebar-footer-bg" class="d-flex align-items-center bgc-white shadow-sm mx-2 mt-2px py-2 radius-t-1 border-x-1 border-t-2 brc-primary-m3">
                                ...
                                <a href="{{ route('panelLogout') }}" class="d-style btn btn-outline-orange btn-h-light-orange btn-a-light-orange border-0 p-2 mr-1" title="Logout"
                                   onclick="event.preventDefault();document.getElementById('logout-form').submit();">
        ...
        <div role="main" class="main-content">
            ...
            <div class="page-content container container-plus">
                ...
                @php
                    $titulo = starts_with(Route::currentRouteName(), 'clientes')? 'Clientes' :
                            (starts_with(Route::currentRouteName(), 'reportes') ? 'Reportes' :
                            (starts_with(Route::currentRouteName(), 'noticias') ? 'Noticias' :
                            (starts_with(Route::currentRouteName(), 'configuracionDeduccionPatronal') ? 'Configuración: Deducciones Patronales' :
                            (starts_with(Route::currentRouteName(), 'configuracionImpuestosRenta') ? 'Configuración: Impuestos de Renta' :
                            (starts_with(Route::currentRouteName(), 'configuracionCreditoFamiliar') ? 'Configuración: Créditos fiscales familiares' :
                            (starts_with(Route::currentRouteName(), 'configuracionEntidadesFinancieras') ? 'Configuración: Catálogo de entidades financieras' :
                            (starts_with(Route::currentRouteName(), 'configuracionCatalogoINS') ? 'Configuración: Catálogo de ocupaciones INS' :
                            (starts_with(Route::currentRouteName(), 'configuracionSalarioMinimo') ? 'Configuración: Salario Mínimo' :
                            (starts_with(Route::currentRouteName(), 'configuracionCatalogoCCSS') ? 'Configuración: Catálogo de ocupaciones CCSS' :
                            (starts_with(Route::currentRouteName(), 'configuracionAccionPersonal') ? 'Configuración: Catálogo de acción de personal' :
                            (starts_with(Route::currentRouteName(), 'configuracionAccionIncapacidad') ? 'Configuración: Catálogo de acción de personal: Incapacidad' :
                            (starts_with(Route::currentRouteName(), 'configuracionCatalogoFeriados') ? 'Configuración: Catálogo de días festivos' :
                            (starts_with(Route::currentRouteName(), 'configuracion') ? 'Configuración' :
                            (starts_with(Route::currentRouteName(), 'panelMiscelaneos') ? 'Misceláneos' :
                            (starts_with(Route::currentRouteName(), 'usuarios') ? 'Usuarios' : '')))))))))))))));


                    $iconoTitulo = starts_with(Route::currentRouteName(), 'clientes') ? 'people-group' :
                            (starts_with(Route::currentRouteName(), 'reportes')? 'file-contract' :
                            (starts_with(Route::currentRouteName(), 'noticias')? 'circle-exclamation' :
                            (starts_with(Route::currentRouteName(), 'configuracion') ? 'screwdriver-wrench' :
                            (starts_with(Route::currentRouteName(), 'panelMiscelaneos') ? 'broom' :
                            (starts_with(Route::currentRouteName(), 'usuarios') ? 'user-group' : '')))));
                @endphp
                <div class="card bcard">
                    <div class="card-header align-items-center">
                        ...
                        @if(str_contains(Route::currentRouteName(), 'create') || str_contains(Route::currentRouteName(), 'edit')|| str_contains(Route::currentRouteName(), 'show')
                            || str_contains(Route::currentRouteName(), 'configuracionCatalogoINS') || str_contains(Route::currentRouteName(), 'configuracionCatalogoCCSS') ||
                            str_contains(Route::currentRouteName(), 'configuracionCatalogoFeriados') || str_contains(Route::currentRouteName(), 'configuracionAccionPersonal'))
                            <div class="d-inline-flex align-items-center ml-sm-0 mb-1">
                                <a href="{{ url()->previous() }}" class="btn btn-outline-blue btn-text-dark btn-h-blue btn-a-blue btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px mb-1">
