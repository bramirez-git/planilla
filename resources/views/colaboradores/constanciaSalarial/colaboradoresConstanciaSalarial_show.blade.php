...
@section('page-content')
    <form class="mt-lg-3" autocomplete="off" method="POST" action="{{route('colaboradoresConstanciaSalarial.store')}}">
        @csrf
        <input type="text" name="accion" value="enviar" hidden>
        <div class="form-group row mt-4">

            <div class="col-md-4 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Nombre de documento') }}</label>
                <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="nombreDocumento" name="nombreDocumento" value="Constancia Salarial" readonly/>
            </div>

            <div class="col-md-4 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Fecha de Creación') }}</label>
                <div class="input-group input-daterange">
                    <input type="text" data-inputmask-alias="date" data-inputmask-inputformat="mm/dd/yyyy" class="form-control text-left  brc-on-focus brc-blue-m1 col-sm-12" id="fechaCreacion" name="fechaCreacion" value="17/10/2022" readonly/>
                </div>
            </div>

            <div class="col-md-4 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Usuario que registra') }}</label>
                <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="usuarioRegistra" name="usuarioRegistra" value="Jafet Sojo" readonly/>
            </div>
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-sm-12">
                ...
                <textarea class="form-control brc-h-blue-l3 brc-h-blue-m1 col-sm-12" maxlength="200" placeholder="Límite de texto 200 caracteres" id="descripcionConstancia" name="descripcionConstancia" readonly>Constancia a solicitud del colaborador</textarea>
            </div>
        ...
        <div class="mt-5 border-t-1 brc-secondary-l2 py-35 mx-n25">
            <div class="md-3 col-md-9 col-sm-12 text-nowrap">
                ...
                <a href="{{ URL::to('/colaboradorConstancia/pdf') }}"  class="btn btn-outline-red btn-text-dark btn-h-red btn-a-red btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px mb-1">
                ...
                <button type="button" data-toggle="modal" data-target="#confirmModal" class="btn btn-outline-info btn-text-dark btn-h-info btn-a-info btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px mb-1">
                        <span class="bgc-info h-5 px-25 pt-2 ml-n1 my-n1 mr-2">
							<i class="fa fa-paper-plane mr-1 text-white text-120 mt-3px"></i>
						</span>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ¿Desea enviar la constancia salarial al colaborador?
                        <br />
                    </div>
