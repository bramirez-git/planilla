                ...
                <div class="card">
                    <div class="card-header text-center bgc-blue-l4">
                        <h4 class="card-title text-secondary">
                            {{ __('Activación de la cuenta asociada al correo: '). $correo }}
                        </h4>
                    </div>
                    <!-- Resto del contenido de la tarjeta -->
                    <div class="card-body">
                        <form method="POST" id="frm-activar-cuenta" action="{{ route('cuentaActiva') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="container form-group row px-3">
                                <h6 class="card-title text-secondary text-center mb-4">
                                    {{ __('Ingresa  tu contraseña personalizada para acceder a tu cuenta')}}
                                </h6>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-12 text-center">
                                    <button type="button" id="activar-cuenta" class="g-recaptcha btn btn-primary">
                                        {{ __('Activar cuenta') }}
                                    </button>
                                </div>
                            </div>
