...
@section('page-content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="text-nowrap align-self-start mb-sm-0 pb-4">
            <a href="{{ route('rh_configuracionFeriados.create') }}" class="btn btn-outline-blue btn-text-dark btn-h-blue btn-a-blue btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px ">
    ...
    <div class="table-responsive">
        ...
        <table id="simple-table" class="mb-0 table table-borderless table-bordered-x brc-secondary-l3 text-dark-m2 radius-1 overflow-hidden">
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionFeriados.destroy',['1']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionFeriados.edit',['1']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionFeriados.edit',['1']) }}" class="dropdown-item">
                                    ...
                                    <div class="modal-body bgc-white-tp2 p-md-4 pl-md-5">
                                        <div class="d-flex align-items-top mr-2 mr-md-5">
                                            ...
                                            <div class="text-secondary-d2 text-105">
                                                ¿Está seguro que desea eliminar el dia feriado?
                                            </div>
                                        </div>
                                    </div>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionFeriados.destroy',['2']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionFeriados.edit',['2']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionFeriados.edit',['2']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionFeriados.destroy',['3']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionFeriados.edit',['3']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionFeriados.edit',['3']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
