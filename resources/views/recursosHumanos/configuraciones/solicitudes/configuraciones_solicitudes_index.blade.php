...
@section('page-content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="text-nowrap align-self-start mb-sm-0 pb-4">
            <a href="{{ route('rh_configuracionTipoSolicitudes.create') }}" class="btn btn-outline-blue btn-text-dark btn-h-blue btn-a-blue btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px ">
                        <span class="bgc-blue h-5 px-25 pt-2 ml-n1 my-n1 mr-2">
							<i class="fa fa-plus mr-1 text-white text-120 mt-3px"></i>
						</span>
                Agregar Tipo de Solicitudes
            </a>
        </div>
    ...
    <div class="table-responsive">
        ...
        <table id="simple-table" class="mb-0 table table-borderless table-bordered-x brc-secondary-l3 text-dark-m2 radius-1 overflow-hidden">
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['1']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['1']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['1']) }}" class="dropdown-item">
                                    ...
                                    <div class="modal-body bgc-white-tp2 p-md-4 pl-md-5">
                                        <div class="d-flex align-items-top mr-2 mr-md-5">
                                            ...
                                            <div class="text-secondary-d2 text-105">
                                                ¿Está seguro que desea eliminar el tipo de solicitud?
                                            </div>
                                        </div>
                                    </div>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['2']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['2']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['2']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['3']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['3']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['3']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['4']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['4']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['4']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['5']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['5']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['5']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['6']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['6']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>

                            <a href="#" data-toggle="modal" data-target="#dangerModal{{'6'}}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger">
                                <i class="fa fa-trash-alt"></i>
                            </a>
                        </div>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['6']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
                                    <a href="#" data-toggle="modal" data-target="#dangerModal{{'6'}}" class="dropdown-item">
                                        <i class="fa fa-trash-alt text-danger-m1 mr-1 p-2 w-4"></i>
                                        {{ __('Eliminar') }}
                                    </a>
                        ...
                        <div class="modal fade" data-backdrop-bg="bgc-white" id="dangerModal{{'6'}}" tabindex="-1" role="dialog" aria-labelledby="dangerModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document">
                                <div class="modal-content bgc-transparent brc-danger-m2 shadow">
                                    <div class="modal-header py-2 bgc-danger-tp1 border-0  radius-t-1">
                                        <h5 class="modal-title text-white-tp1 text-110 pl-2 font-bolder" id="dangerModalLabel">
            ...
            <tr class="bgc-h-blue-l4 d-style">
                ...
                <td>
                    <form method="POST" action="{{ route('rh_configuracionTipoSolicitudes.destroy',['7']) }}">
                        @csrf
                        @method('DELETE')
                        <!-- action buttons -->
                        <div class='d-none d-lg-flex float-right'>
                            <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['7']) }}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                <i class="fa fa-pencil-alt"></i>
                            </a>

                            <a href="#" data-toggle="modal" data-target="#dangerModal{{'7'}}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger">
                                <i class="fa fa-trash-alt"></i>
                            </a>
                        </div>
                        ...
                        <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                            ...
                            <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                <div class="dropdown-inner">
                                    ...
                                    <a href="{{ route('rh_configuracionTipoSolicitudes.edit',['7']) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-alt text-blue mr-1 p-2 w-4"></i>
                                        {{ __('Editar') }}
                                    </a>
                                    <a href="#" data-toggle="modal" data-target="#dangerModal{{'7'}}" class="dropdown-item">
                                        <i class="fa fa-trash-alt text-danger-m1 mr-1 p-2 w-4"></i>
                                        {{ __('Eliminar') }}
                                    </a>
                        ...
                        <div class="modal fade" data-backdrop-bg="bgc-white" id="dangerModal{{'7'}}" tabindex="-1" role="dialog" aria-labelledby="dangerModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document">
                                <div class="modal-content bgc-transparent brc-danger-m2 shadow">
                                    <div class="modal-header py-2 bgc-danger-tp1 border-0  radius-t-1">
                                        <h5 class="modal-title text-white-tp1 text-110 pl-2 font-bolder" id="dangerModalLabel">
