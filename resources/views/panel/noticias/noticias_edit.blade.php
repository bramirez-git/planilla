...
@section('page-content')
    <form class="mt-lg-3" id="frm-noticias" name="frm-noticias" autocomplete="off" method="POST" action="{{route('noticiasPanel.update',[Crypt::encrypt($resultado->id_noticia)])}}">
        @csrf
        @method('PUT')
        <div class="form-group row mt-4">
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="titulo" value="{{$resultado->titulo}}" name="titulo"  />
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <select data-placeholder="Seleccione una opción..." class="chosen-select form-control" id="estado" name="estado" >
                    <option @if($resultado->estado=="activa") selected  @endif value="activa">Activo</option>
                    <option @if($resultado->estado=="inactiva") selected  @endif value="inactiva">Inactivo</option>
                    <option @if($resultado->estado=="pendiente") selected  @endif value="pendiente">Pendiente</option>
                </select>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="input-group input-daterange">
                    <input type="text" data-inputmask-alias="date" data-inputmask-inputformat="mm/dd/yyyy" class="form-control text-left brc-on-focus brc-blue-m1 col-sm-12" id="fechaPublicacion" value="{{ old('fechaPublicacion') ?? date("d/m/Y",strtotime($resultado->fecha)) }}" name="fechaPublicacion" required="true"/>
                </div>
            </div>

            <div class="col-md-3 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('URL') }}</label>
                <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="url" name="url" value="{{ $resultado->url_web }}"/>
            </div>
        </div>
        ...
        <div class="form-group row mt-4">
            <div class="col-sm-12">
                ...
                <textarea class="form-control brc-h-blue-l3 brc-h-blue-m1 col-sm-12" maxlength="200" placeholder="Límite de texto 200 caracteres" id="descripcion" name="descripcion">{{ $resultado->descripcion }}</textarea>
            </div>
        </div>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ¿Desea modificar el registro de la noticia?
                        <br />
                    </div>
