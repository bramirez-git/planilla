...
@section('page-content')
    ...
    <form class="mt-lg-3" id="frm-marketplaces" name="frm-marketplaces" autocomplete="off" method="POST" action="{{route('marketplace.update',[$id_servicio])}}">
        @csrf
        @method('PUT')
                <div class="form-group row mt-4">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="nombre_modulo" name="nombre_modulo" placeholder="Ingrese nombre del módulo" required="true" value="{{ old('nombre_modulo') ?? $resultado->nombre }}"/>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="precio" name="precio" placeholder="Ingrese el precio"
                                   class="form-control brc-on-focus brc-blue-m1"
                                   value="{{ old('precio') ?? $resultado->precio }}">
                        </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <div>
                            ...
                            <input type="checkbox" id="estado" name="estado" class="ace-switch input-lg ace-switch-bars-h ace-switch-check ace-switch-times text-grey-l2 bgc-green-d2 radius-2px" style="margin-top: 1.8px;" <?php echo ($resultado->estado == 'activo') ? 'checked' : ''; ?>>
                        </div>
                   </div>
                </div>
                ...
                <div class="form-group row mt-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese descripción de producto" style="resize: none; width: 100%; overflow-y: hidden;" required="true">{{ old('descripcion') ?? $resultado->descripcion }}</textarea>
                    </div>
                </div>
...
<!--                 <div class="form-group row mt-4">
                ...
                <div class="form-group row mt-4">
                    <div class="col-sm-12">
                        ...
                        <textarea id="editor" name="editor">{{ old('editor') ?? $resultado->terminos_condiciones }}</textarea>
                    </div>
                </div>
           ...
           <!--      <div class="form-group row mt-4" id="campoArchivo" style="display: none;">
                ...
                <div class="mt-5 border-t-1 brc-secondary-l2 py-35 mx-n25">
                    <div class="md-3 col-md-9 col-sm-12 text-nowrap">
                        ...
                        <button type="button" id="actualizar" data-toggle="modal" data-target="#confirmModal" class="btn btn-outline-blue btn-text-dark btn-h-blue btn-a-blue btn-bold radius-1 d-inline-flex align-items-center pl-3px py-3px mb-1">
