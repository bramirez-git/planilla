...
@section('page-content')
    <form class="mt-lg-3" id="frm-feriados" name="frm-feriados" autocomplete="off" method="POST" action="{{route('configuracionCatalogoFeriados.store')}}">
        @csrf
        <div class="form-group row mt-4">
            <div class="col-md-3 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Celebración') }}</label>
                <input type="text" class="form-control brc-on-focus brc-blue-m1 col-sm-12" id="celebracion" name="celebracion"  />
            </div>

            <div class="col-md-3 col-sm-12">
                <label for="id-form-field-focus-1" class="mb-0 text-blue-m1"> {{ __('Fecha celebración') }}</label>
                <div class="input-group input-daterange">
                    <input type="text" data-inputmask-alias="date" data-inputmask-inputformat="mm/dd/yyyy" class="form-control text-left  brc-on-focus brc-blue-m1 col-sm-12" id="fechaFeriado" name="fechaFeriado" />
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="input-group input-daterange">
                    <input type="text" data-inputmask-alias="date" data-inputmask-inputformat="mm/dd/yyyy" class="form-control text-left  brc-on-focus brc-blue-m1 col-sm-12" id="fechaTraslado" name="fechaTraslado" />
                </div>
            </div>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ¿Desea guardar el registro de la celebración ?
                        <br />
                    </div>
