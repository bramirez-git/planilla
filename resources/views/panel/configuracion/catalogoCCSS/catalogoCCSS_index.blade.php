        ...
        <div class="text-nowrap align-self-start pl-md-2">
            <div class="d-inline-flex align-items-center ml-sm-0 pb-4">
                <div class="d-flex flex-row-reverse">
                                    ...
                                    <form class="dropdown-clickable text-grey-d2" autocomplete="off" method="GET" id="frm_filros" action="">
                                        ...
                                        <div class="dropdown-body my-25 px-3">
                                            ...
                                            <div class="d-flex align-items-center px-2 px-md-3">
                                                ...
                                                <select class="ace-select text-secondary-d2 no-border brc-h-blue-m3" name="filtro[buscar]">
                                                    <option value="codigo" @if($to_look_for=="codigo") selected @endif>Código</option>
                                                    <option value="nombre" @if($to_look_for=="nombre") selected @endif>Ocupación</option>
                                                    <option value="clasificacion" @if($to_look_for=="clasificacion") selected @endif>Clasificación</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center px-2 px-md-3">
                                                ...
                                                <select class="ace-select text-secondary-d2 no-border brc-h-blue-m3" name="filtro[orden]">
                                                    ...
                                                    <option value="codigo" @if($orden=="codigo") selected @endif>Código</option>
                    ...
                    <div class="px-1">
                        <a href="{{route('configuracionCatalogoCCSS.index')}}" class="btn btn-outline-green radius-1 d-inline-flex align-items-center h-100 btn-modal-cargando">
                        ...
                        <div class="dropdown d-inline-block h-100">
                            ...
                            <div class="dropdown-menu dropdown-caret">
                                @if(!$resultado->isEmpty())
                                    <button id="descarga_excel_CCSS" class="dropdown-item">Descargar excel</button>
                                @endif
                                <a class="dropdown-item" href="{{ route('configuracionCatalogoCCSS.create') }}">Subir excel</a>
                                <a href="{{ route('plantillaCatalogoCCSS') }}" class="dropdown-item">Descargar plantilla de excel</a>
                            </div>
                        </div>
                    </div>
                </div>
