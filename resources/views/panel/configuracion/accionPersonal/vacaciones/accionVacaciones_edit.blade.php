...
@section('page-content')
    <form class="mt-lg-3" id="frm-permisos" name="frm-permisos" autocomplete="off" method="POST" action="{{route('configuracionAccionVacaciones.update',['5'])}}">
        @csrf
        @method('PUT')
        <div class="form-group row">
                ...
                <div class="card bgc-primary-d3 h-100" id="card-13" draggable="true">
                    ...
                    <div class="card-body p-0 text-white collapse show">
                        <div class="alert bgc-blue-l3 brc-blue-l1 text-dark-tp2" role="alert">
                            <p>El colaborador disfruta de sus días solicitados pero estos deben ser rebajados
                                de los calculos realizados en la planilla, ya que descuentan del salario devengado
                                el rubro mismo.</p>
                        </div>
            ...
            <div class="col-lg-6 col-sm-12 mt-3 mt-sm-0 cards-container" id="card-container-12">
                <div class="card bgc-primary-d3 h-100" id="card-13" draggable="true">
                    ...
                    <div class="card-body p-0 text-white collapse show">
                        <div class="alert bgc-blue-l3 brc-blue-l1 text-dark-tp2" role="alert">
                            <p>El colaborador disfruta de sus días solicitados pero estos son reconocidos
                                como si los trabajara a nivel salarial.</p>
                        </div>
